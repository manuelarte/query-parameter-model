...
public class GreaterThanOrEqualToOperatorTest {
  ...
  private static final Operator<String> GREATER_THAN_OR_EQUALS_OPERATOR =
  ...
  public void greaterThanOrEqualTo_IntegerInput_Success() {
    ...
    final String obtained = GREATER_THAN_OR_EQUALS_OPERATOR
        .formatValue(GREATER_THAN_OR_EQUALS_OPERATOR.getValue(afterKey));
